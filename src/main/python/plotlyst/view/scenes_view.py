...
class ScenesOutlineView(AbstractNovelView):
    ...
    def _on_custom_menu_requested(self, pos: QPoint):
        ...
        # self.btn.show()
        # self.text = QLineEdit()
        # self.text.setWindowFlag(Qt.FramelessWindowHint)
        self.dialog = AboutDialog()
        self.dialog.setWindowFlag(Qt.FramelessWindowHint)
        self.dialog.show()
        self.dialog.activateWindow()
        # self.text.show()
        # self.text.editingFinished.connect(self.text.deleteLater)
        self.dialog.move(self.ui.tblScenes.viewport().mapToGlobal(pos))
        # self.text.move(self.ui.tblScenes.viewport().mapToGlobal(pos))
