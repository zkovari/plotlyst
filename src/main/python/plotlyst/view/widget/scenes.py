...
import qtanim
from PyQt6.QtCore import QPoint, QTimeLine, QMimeData, QPointF
...
from qthandy.filter import InstantTooltipEventFilter, VisibilityToggleEventFilter, \
...
from src.main.python.plotlyst.core.domain import Scene, Novel, SceneType, \
    SceneStructureItem, SceneOutcome, StoryBeat, Plot, ScenePlotReference, Chapter, StoryBeatType, Tag, PlotValue, \
