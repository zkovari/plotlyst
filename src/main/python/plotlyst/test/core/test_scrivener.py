...
def test_import_with_acts():
    ...
    chapters = [Chapter(title='Chapter', sequence=0, id=UUID('58D0189B-0507-4669-B129-4A392CF07F36')),
                Chapter(title='Chapter', sequence=0, id=UUID('567B89D4-21E4-44DF-BD5C-3F32EEC78ADD')),
                Chapter(title='Chapter', sequence=0, id=UUID('245C2ABD-E9C1-4091-B1B7-DA32402644E7'))]
