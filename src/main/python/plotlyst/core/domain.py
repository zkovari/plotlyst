...
three_act_structure = StoryStructure(title='Three Act Structure',
                                     ...
                                     beats=[StoryBeat(text='Hook',
                                            ...
                                            StoryBeat(text='Inciting Incident',
                                                      ...
                                                      icon_color='#a2ad59',
                                                      description="The first real event that changes the protagonist's status quo. Often an external conflict is involved that raises the stakes and sets the protagonist in a new direction.",
                                            ...
                                            StoryBeat(text='First Plot Point',
                                                      icon='mdi.dice-1',
                                                      icon_color='#2a4494',
                                                      description="First Point of No Return beat. The protagonist enters a new world, sometimes physically, by making a decision and addressing the Inciting Incident.",
...
save_the_cat = StoryStructure(title='Save the Cat',
                              ...
                              beats=[StoryBeat(text='Opening Image',
                                     ...
                                     StoryBeat(text='Break into Two',
                                               ...
                                               icon_color='#1bbc9c',
                                               description="First Point of No Return beat. The protagonist enters a new world, sometimes physically, by making a decision and addressing the Catalyst event.",
                                     ...
                                     StoryBeat(text='Midpoint',
                                               icon='mdi.middleware-outline',
                                               icon_color='#2e86ab',
                                               description="Another Point of No Return beat with a false defeat or false victory moment that raises the stakes. Often Story A and Story B intersect. The protagonist becomes proactive from reactive.",
