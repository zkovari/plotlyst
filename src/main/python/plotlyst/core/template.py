...
def default_character_profiles() -> List[ProfileTemplate]:
    ...
    fields = [ProfileElement(summary_title, 0, 0, col_span=2),
              ...
              # ProfileElement(motivation_field, 11, 0, margins=Margins(left=15)),
              # ProfileElement(internal_motivation_field, 11, 1, margins=Margins(left=10)),
              # ProfileElement(arrow_field(), 12, 0),
              # ProfileElement(internal_arrow_field(), 12, 1),
              # ProfileElement(conflict_field, 13, 0, margins=Margins(left=15)),
              # ProfileElement(internal_conflict_field, 13, 1, margins=Margins(left=10)),
              # ProfileElement(arrow_field(), 12, 0),
              # ProfileElement(internal_arrow_field(), 12, 1),
